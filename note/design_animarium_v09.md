...
**v0.9 — 30 luglio 2026**
Riferimento dati: `GSP_popolazioni_full_riferimento_v18.md`, **v1.8**.
I rimandi a §13, §14 e §15 senza altra indicazione sono a quel documento.

*Rispetto alla v0.8: i risultati sulla pipeline sono migrati al documento
di riferimento GSP, v1.8 — §13 lo strato donatore AVQ, §14 il constraint set
e lo stato del pool, §15 l'allocazione. Qui restano i rimandi e cio' che
governa il viewer. Ridotte §2.2, §13.1, §13.4 e §13.6; riscritta §11,
separando le questioni del viewer da quelle della pipeline.*
...
2. **Fonte delle medie nazionali AVQ 2024** — vigili del fuoco 8,10, forze
   dell'ordine 6,70, ASL 6,34, Comune 5,13, Regione 4,65. Entrate nel design
   alla v0.1 **senza citazione**, e oggi stampate come tacche nel pannello
   della fiducia, quindi **gia' pubbliche**. Da verificare o togliere.
